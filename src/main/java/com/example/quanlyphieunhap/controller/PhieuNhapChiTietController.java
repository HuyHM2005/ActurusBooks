...
public class PhieuNhapChiTietController {
    ...
    public String hienThi(Model model) {
        ...
        Map<Integer, PhieuNhap> phieuNhapMap = phieuNhapList.stream().collect(Collectors.toMap(PhieuNhap::getId, pn -> pn));
    ...
    @PostMapping("/add")
    public String add(@Valid @ModelAttribute("chiTiet") PhieuNhapChiTiet chiTiet,
    ...
    public String detail(@RequestParam("id") Integer id, Model model) {
        ...
        if (chiTiet != null) {
            ...
            chiTietView.put("ngaySanXuatStr", chiTiet.getNgaySanXuat() != null ? chiTiet.getNgaySanXuat().format(formatter) : "");
        }
        List<Map<String, Object>> listView = list.stream().map(ct -> {
            Map<String, Object> map = new HashMap<>();
            map.put("ct", ct);
